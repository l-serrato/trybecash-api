...
const connection = require('../../src/db/connections');
...
describe('Testando os endpoints de people', function () {
  ...
  it('Testando a alteração de uma pessoa com o id 2', async function () {
    ...
    expect(response.status).to.equal(200);
    expect(response.body).to
      .deep.equal({ message: 'Pessoa de id 2 atualizada com sucesso' });
  });
